...
sleep 5
echo -e "y" | git clone https://github.com/shyoon71/aptos-core.git
sleep 0.1
echo -e "1" | curl https://sh.rustup.rs -sSf | sh
sleep 0.1
source $HOME/.cargo/env
sleep 0.1
echo ""
echo -e "y" | cargo install --git https://github.com/aptos-labs/aptos-core.git aptos
sleep 1
cd aptos-core
